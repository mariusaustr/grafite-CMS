...
class EventsTest extends TestCase
{
    ...
    */
    ...
    {
        $response = $this->get('cms/events/create');
        $this->assertEquals(200, $response->getStatusCode());
    }

    public function testEdit()
    {
        $response = $this->get('cms/events/1/edit');
        $this->assertEquals(200, $response->getStatusCode());
    ...
    */
    ...
    public function testStore()
    {
        ...
        $response = $this->post('cms/events', $event);
    ...
    {
        $response = $this->post('cms/events/search', ['term' => 'wtf']);
    ...
    public function testUpdate()
    {
        ...
        $response = $this->patch('cms/events/2', [
            'title' => 'smarter',
        ]);
    ...
    {
        $response = $this->delete('cms/events/1');
        $this->assertEquals(302, $response->getStatusCode());
